...
<jsp:include page="/WEB-INF/views/admin/admin_header.jsp">
	<jsp:param value="게시판 수정 페이지" name="title"/>
</jsp:include>
			...
			<tr>
				<td>
					<table id="admin_board_table2">
						...
						<tr>
							<td>제목</td>
							<td><input type="text" id="board_title" name="board_title" required value="${board.boardTitle }"></td>
						</tr>
						<tr style="height: 750px;">
							<td>내용</td>
							<td>
							<textarea id="txtContent" name="txtContent" rows="20" cols="100" style="width: 90%;" required>${board.boardContent }</textarea>
							<!-- editor -->
							<script>
								var ckeditor_config = {
									resize_enaleb: true,
